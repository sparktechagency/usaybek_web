...
//       <AlertDialog open={dialogState.open} onOpenChange={closeDialog}>
//         <AlertDialogContent
//           className={cn("rounded-md w-[420px] px-20", dialogState?.className)}
//         >
//           <AlertDialogHeader>
//             <AlertDialogTitle>
//               <ul>
//                 <li className="flex justify-center mb-2">
//                   {dialogState.icon == "i1" && (
//                     <FavIcon name="delete" className="size-12" />
//                   )}
//                   {dialogState.icon == "i2" && (
//                     <Icon name="alertRed" width={50} height={50} />
//                   )}
//                   {dialogState.icon == "i3" && (
//                     <FavIcon name="check" className="size-15" />
//                   )}
//                 </li>
//                 <li
//                   className={cn(
//                     "text-center text-reds text-2xl",
//                     dialogState.titleStyle
//                   )}
//                 >
//                   {dialogState.title || "Are you sure to delete this video ?"}
//                 </li>
//               </ul>
//             </AlertDialogTitle>
