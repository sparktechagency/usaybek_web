...
import { Button, Card, CardDescription, CardHeader, CardTitle, Checkbox, Label } from '@/components/ui'
      ...
      <div className="relative z-10 max-w-7xl h-full mx-auto flex flex-col  justify-center">
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
          <div className='text-center hidden md:block text-white self-center'>
            ...
            <h1 className='font-medium text-xl'>Connect with your town like never before</h1>
            <ul className='space-y-2 mt-4 pl-50'>
              {["Access your personalized feed",
                "Interact with local experts",
                "Stay updated with your town"]
                .map((item, index) => (
                  <li className='flex gap-1' key={index}><Icon name='checkWhite' width={20} height={20} />{item}</li>
                ))}
            </ul>
          </div>
          <div>
            <Card className="w-full max-w-md rounded-md md:rounded-none md:rounded-t-xl px-4 py-8 bg-body border-none mx-auto md:absolute md:right-0 md:bottom-0">
              ...
              <Form className="space-y-6 pt-4" from={from} onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <Link href="/forgot-password" className="text-reds font-semibold hover:underline">
                    Forgot Password ?
                  </Link>
                </div>
                <Button
              ...
              <div className="text-center text-sm flex justify-center font-medium">
                ...
                <Link href="/sign-up" className="flex items-center justify-center gap-1 ml-1 hover:underline">
