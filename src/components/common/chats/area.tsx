...
interface charProps extends childrenProps {
  analytics: {
...
export function ChartAreaOverView({ children, analytics }: charProps) {
  ...
  const activeDataKey = statusToDataKey[status as keyof typeof statusToDataKey] || "views";
  ...
  return (
    <div>
      ...
      <Card className={cn("p-0 shadow-none border-[1px] mt-2")}>
            ...
            <AreaChart data={filteredData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
              <defs>
                <linearGradient id="filllike" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-like)" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="var(--color-like)" stopOpacity={0.1} />
                </linearGradient>
                ...
                <linearGradient id="filldislike" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-dislike)" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="var(--color-dislike)" stopOpacity={0.1} />
                </linearGradient>
              </defs>
