...
export default function Navber() {
    ...
    return (
        <div ref={headerRef} className='sticky z-50 top-0 left-0'>
            <ul className="relative  z-10 max-w-screen px-20 flex items-center flex-wrap space-y-2 md:space-y-0 justify-center md:justify-between py-5">
                ...
                <li>
                    <div className="flex items-center  rounded-full bg-[white] pl-2 pr-1  w-full md:max-w-5xl mx-auto">
                        <input
                            type="text"
                            placeholder="Service"
